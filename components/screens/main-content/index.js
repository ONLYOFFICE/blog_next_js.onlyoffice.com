...
const Main = ({ t, locale, mainPostExcerpt, allPosts, productReleasesPosts, forDevelopersPosts, forBusinessPosts, forEducationPosts, inThePressPosts, isMainPage }) => {
  const mainPost = true;
  ...
  return (
    <StyledMainContent>
      ...
      <div className="wrapper-posts">
        ...
        <div className="category-posts">
          <LoadMorePosts t={t} locale={locale} data={allPosts} isMainPage={isMainPage} />
        </div>
      </div>
    </StyledMainContent>
  );
