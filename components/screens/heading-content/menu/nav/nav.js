          ...
          <MenuItem heading={t("Products")} id="navitem-products" navHidden={navHidden} setNavHidden={setNavHidden}>
            <div className="menu-wrapper">
              ...
              <div className="outer-box">
                ...
                <InternalLink id="navitem-products-oforms" className="dropdown-item" href={`https://oforms.onlyoffice.com/${locale === "en" || locale === "el" || locale === "cs" ? "" : locale === "zh-hans" ? "zh" : locale === "pt-br" ? "pt" : locale}`} label={t("Fill out forms online")} />
