                ...
                <div className="menu-box bg-gray">
                  ...
                  <div className="menu-submenu">
                    ...
                    <div className="menu-box-inner">
                      ...
                      <InternalLink className="menu-link find-pdf-form-templates" href={oformsHrefLang} label={t("Find PDF form templates")} />
                      <InternalLink className="menu-link fill-out-pdf-forms-online" href={oformsHrefLang} label={t("Fill out PDF forms online")} />
                    </div>
                    <div className="menu-box-inner">
