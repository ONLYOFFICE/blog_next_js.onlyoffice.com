...
const Footer = ({ t, locale }) => {
  ...
  const blogHrefLang = `https://onlyoffice.com/blog${locale === "en" ? "" : `/${locale}`}`;
    ...
    <StyledFooter className={locale} locale={locale}>
      ...
      <div className="footer-item-group">
        ...
        <FooterItem heading={t("Contact us")} className="contacts">
          ...
          <Text className="contact-text">
            {t("Partner inquiries")}{locale === "zh-hans" || locale === "ja" ? "" : " "}<InternalLink className="footer-link-contact" label={t("partners@onlyoffice.com")} href="mailto:partners@onlyoffice.com" />
          </Text>
          <Text className="contact-text">
            {t("Press inquiries")}{locale === "zh-hans" || locale === "ja" ? "" : " "}<InternalLink className="footer-link-contact" label={t("press@onlyoffice.com")} href="mailto:press@onlyoffice.com" />
          </Text>
      ...
      <div className="footer-item-group-last">
        <div className="footer-follow">
          ...
          <SocialLinks locale={locale} handlerSetModal={handlerSetModal} isFooter={isFooter} />
        </div>
