    ...
    <StyledFooter className={locale} locale={locale}>
      ...
      <div className="footer-item-group">
        <FooterItem heading={t("Get news")} className="get-news">
          <ExternalLink className="footer-link" href={`https://onlyoffice.com/blog${locale === "en" ? "" : `/${locale}`}`} label={t("Blog")} />
        </FooterItem>
      ...
      <div className="footer-item-group">
        ...
        <FooterItem heading={t("Contact us")} className="contacts">
          <Text className="contact-text">
            {`${t("Sales questions")}${locale === "zh-hans" || "ja" ? "" : " "}`}<ExternalLink className="footer-link-contact" label={t("sales@onlyoffice.com")} href="mailto:sales@onlyoffice.com" />
          </Text>
          <Text className="contact-text">
            {`${t("Partner inquiries")}${locale === "zh-hans" || "ja" ? "" : " "}`}
            <ExternalLink className="footer-link-contact" label={t("partners@onlyoffice.com")} href="mailto:partners@onlyoffice.com" />
          </Text>
          <Text className="contact-text">
            {`${t("Press inquiries")}${locale === "zh-hans" || "ja" ? "" : " "}`}
