...
const SocialLinks = ({ locale, handlerSetModal, isFooterContent, isFollowUsContent }) => {
  ...
  return (
    <StyledSocialLinks className={`social-links ${locale}`}>
      ...
      {locale === "ja" ? (
        <>
          <ExternalLink className="social-link blog" href={`https://www.onlyoffice.com/blog/`} title="Blog" alt="Blog"></ExternalLink>
          <ExternalLink className="social-link x" href={xUrl} title="X" alt="X"></ExternalLink>
          <ExternalLink className="social-link note" href="https://note.com/onlyoffice" title="Note" alt="Note"></ExternalLink>
          <ExternalLink className="social-link qiita" href="https://qiita.com/ONLYOFFICE" title="Qiita" alt="Qiita"></ExternalLink>
          ...
          <ExternalLink className="social-link linkedin" href={linkedinUrl} rel="nofollow" title="LinkedIn" alt="LinkedIn"></ExternalLink>
          ...
          <ExternalLink className="social-link telegram" href={telegramUrl} title="Telegram" alt="Telegram"></ExternalLink>
        </>
      ) : (
        <>
          {isFollowUsContent && locale === "zh-hans" && (
          ...
          <ExternalLink className="social-link twitter" href={xUrl} rel="nofollow" title="Twitter" alt="Twitter"></ExternalLink>
          <ExternalLink className="social-link linkedin" href={linkedinUrl} rel="nofollow" title="LinkedIn" alt="LinkedIn"></ExternalLink>
          <ExternalLink className="social-link youtube" href="https://www.youtube.com/user/onlyofficeTV" rel="nofollow" title="YouTube" alt="YouTube"></ExternalLink>
          ...
          <ExternalLink className="social-link github" href="https://github.com/ONLYOFFICE/" title="GitHub" alt="GitHub"></ExternalLink>
          <ExternalLink className="social-link fosstodon" href="https://fosstodon.org/@ONLYOFFICE" title="Fosstodon" alt="Fosstodon"></ExternalLink>
          {isFooterContent && locale === "zh-hans" && (
            <div className="icon-item">
              <span className="wdgt-wechat" title="WeChat"></span>
              <div className="popup-qr-code wechat-qr-code">
                <p>关注我们</p>
